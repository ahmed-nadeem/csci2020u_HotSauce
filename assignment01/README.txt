...
Question 4:
Open Question4.java from src folder and run file. In the text field, type in the absolute filepath of a text file, and then either hit enter in the text field or click the view button to show the histogram.
